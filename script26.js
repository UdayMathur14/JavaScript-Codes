...
console.log(0=='');
// it gives true why because whenever i pass a empty string it converts it into 0 and then 0 is equal to 0 so my answer is true 
...
console.log('\n'=='\t');
// yeh false de rha h but kyu dono toh 0 hi ha ,because  agr dono ka datatype same h toh wo typecast nhi krega means usko change krke nhi dekhaga number m , and typecast krne ki zaroorat nhi pdi toh yeh dono toh phir string hi ha nah and dono string different h toh false hi hoga 

console.log([1,2] == [1,2]);
// yeh false de rha h kyuki datatype toh same h but value alag h are bhai value bhi toh same h , abe ghoju tu bhul gya ki arrays give the address not value , so yeh dono array toh bne hua h but inke address alag alag h toh isne false de diya h 
